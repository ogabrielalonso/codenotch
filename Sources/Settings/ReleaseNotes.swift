    ...
    static var all: [ReleaseNote] {
        [
            ...
            ReleaseNote(
                ...
                changes: [
                    ReleaseNote.Change(
                        title: L10n.t("Every language"),
                        detail: L10n.t("The What's New notes of this fork now read in all of Codenotch's languages, and English stays the default for everyone else.")
                    ),
                ]
            ),
            ReleaseNote(
